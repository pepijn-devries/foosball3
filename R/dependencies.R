...
#' @importFrom dplyr add_row any_of arrange bind_rows collect copy_to filter left_join mutate n pull row_number rows_update rows_upsert rowwise sample_n select slice_sample summarise tbl tibble
